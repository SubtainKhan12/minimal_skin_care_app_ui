...
class _CustomBottomNavBarState extends State<CustomBottomNavBar> with TickerProviderStateMixin {
  final List<IconData> icons = [Icons.home_outlined, Icons.search, Icons.person_outline, Icons.shopping_cart_outlined];
  ...
  void initState() {
    ...
    _separationAnimation = Tween<double>(
      begin: 0.0,
      end: 1.0,
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow:
              isSelected
                  ? [BoxShadow(color: const Color(0xFF434127).withOpacity(0.3), blurRadius: 12, offset: const Offset(0, 4))]
            ...
            return Transform.scale(
              ...
              child: Row(
                ...
                children: [
                  ...
                  if (isSelected) ...[
                    AnimatedContainer(duration: const Duration(milliseconds: 300), width: 8 * _separationAnimation.value),
                    AnimatedOpacity(
                      duration: const Duration(milliseconds: 300),
                    ...
                    children: [
                      ...
                      if (widget.currentIndex > 0) ...[
                        AnimatedContainer(
                          ...
                          decoration: BoxDecoration(
                            gradient: LinearGradient(
                              colors: [const Color(0xFF434127).withOpacity(0.2), Colors.transparent],
                          ...
                          child: Row(
                            ...
                            children: [
                              for (int i = 0; i < widget.currentIndex; i++) ...[
                                ...
                                if (i < widget.currentIndex - 1) SizedBox(width: 8),
                              ],
                            ],
                          ),
                        ),
                        AnimatedContainer(duration: const Duration(milliseconds: 300), width: 10 * _separationAnimation.value),
                      ],
                      ...
                      AnimatedContainer(
                        ...
                        transform: Matrix4.identity()..scale(1.0 + (0.01 * _separationAnimation.value)),
                        child: Container(
                          padding: const EdgeInsets.all(3),
                          decoration: BoxDecoration(
                            gradient: LinearGradient(
                              colors: [const Color(0xFF434127).withOpacity(0.7), Colors.transparent],
                      ...
                      if (widget.currentIndex < icons.length - 1) ...[
                        AnimatedContainer(duration: const Duration(milliseconds: 300), width: 12 * _separationAnimation.value),
                        AnimatedContainer(
                          duration: const Duration(milliseconds: 300),
                          padding: EdgeInsets.symmetric(horizontal: 8, vertical: 4),
                          decoration: BoxDecoration(
                          ...
                          child: Row(
                            mainAxisSize: MainAxisSize.min,
                            children: [
                              for (int i = widget.currentIndex + 1; i < icons.length; i++) ...[
                                _buildNavItem(i, false),
